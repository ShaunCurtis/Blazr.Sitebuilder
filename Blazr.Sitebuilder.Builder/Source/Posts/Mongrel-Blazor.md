...
Create a solution using the *Blazor Web Project* with the *InteractiveAuto* and *Per Page/Component* options.
...
![Home Server Rendered](./assets/Mongrel-Blazor/Home-ServerRendered.png)
...
![Render Fragment Exception](./assets/Mongrel-Blazor/RenderFragment-exception.png)
